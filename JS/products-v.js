  ...
  products.forEach((product) => {
    ...
    card.innerHTML = `
      ...
      <div class="content">
        ...
        <div class="buttons">
          <a href="../HTML/contact-f.html?farmer_id=${product.farmer_id}&product=${product.name}&price=${product.price_per_kg}">
            <button class="edit-btn">Contact</button>
          </a>
          <a href="../HTML/orders-products-v.html?id=${product.id}&price=${product.price_per_kg}&farmer_id=${product.farmer_id}">
